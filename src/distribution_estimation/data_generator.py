...
class DataGenerator(object):
    ...
    is generated by a random matrix of orthogonal eigen_vectors Q and a uniform random choice of eigenvalues L,
    in between the bounds specified by min_eigenvalue and min_eigenvalue (specified in distribution_configuration).
    A = QLQt. The covariance matrix for this Gaussian is therefore: Sigma = At A = Q L^2 Qt
    """
    def __init__(self, conf, pdf_functions, random):
        """ This constructor will create the positive definate matrix A for the Gaussian, which will be used later for
        drawing samples.
